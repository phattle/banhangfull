...
namespace Commons.Libs
{
    public class XMail
    {
        public static string SMTPServer = WebConfigurationManager.AppSettings["SMTPServerGo"].ToString();
        public static int Port = Int32.Parse(WebConfigurationManager.AppSettings["PortGo"].ToString());
        ...
        public static string from = "cskh@onchotto.com";
