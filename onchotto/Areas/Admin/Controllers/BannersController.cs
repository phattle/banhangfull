...
namespace OnChotto.Areas.Admin.Controllers
{
    public class BannersController : AdminController
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "BannerId,Name,BannerTypeId,BannerPositionId,Description,Image,Url,StartDate,EndDate,Active")] Banner banner)
        {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "BannerId,Name,BannerTypeId,BannerPositionId,Description,Image,Url,StartDate,EndDate,Active")] Banner banner)
        {
            if (ModelState.IsValid)
            {
