...
namespace OnChotto.Areas.Admin.Controllers
{
    public class CategoriesController : AdminController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Slug,Description,ParentId,DisplayOrder")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Slug,Description,ParentId,DisplayOrder")] Category category)
        {
            if (ModelState.IsValid)
            {
