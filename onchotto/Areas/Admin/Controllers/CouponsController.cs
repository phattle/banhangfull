...
namespace OnChotto.Areas.Admin.Controllers
{
    public class CouponsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Code,Name,Discount,DiscountFor,DiscountForId,LimitedUsed,Description")] Coupon coupon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Code,Name,Discount,DiscountFor,DiscountForId,LimitedUsed,Description")] Coupon coupon)
        {
            if (ModelState.IsValid)
            {
