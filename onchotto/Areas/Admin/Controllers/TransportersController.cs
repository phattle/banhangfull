...
{
    public class TransportersController : AdminController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Logo,Phone,Address,ContactName,Active")] Transporter transporter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Logo,Phone,Address,ContactName,Active")] Transporter transporter)
        {
            if (ModelState.IsValid)
            {
