...
namespace OnChotto.Areas.Admin.Controllers
{
    public class TransportTypesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            TransportType transportType = db.TransportTypes.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] TransportType transportType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] TransportType transportType)
        {
            if (ModelState.IsValid)
            {
