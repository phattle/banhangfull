...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        PluginSettings.Add("ImageResize_smallThumb", "120x120" );
        PluginSettings.Add("ImageResize_mediumThumb", "220x220" );
        PluginSettings.Add("ImageResize_largeThumb", "380x380" );
        // Name of the watermark image in plugins/watermark folder
        PluginSettings.Add("Watermark_source", "~/Content/images/logo-Hotdealvn.png" );
