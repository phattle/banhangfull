namespace OnChotto.Models
{
    ...
    public class StoreDiffCart
    {
        ...
        //        {
        //            iTotal += Common.CorrectValue(item.WeightKG * item.Amount, decimal.Zero);
        //        }
        //        return iTotal;
        //    }
        //}
        ...
        public static StoreDiffCart Cart
        {
            get
            {
                var cart = HttpContext.Current.Session["Cart"] as StoreDiffCart;
                // Nếu chưa có giỏ hàng trong session -> tạo mới và lưu vào session
                if (cart == null)
                {
                    cart = new StoreDiffCart();
                    //cart.Count = 0;
                    //cart.Total = 0;
